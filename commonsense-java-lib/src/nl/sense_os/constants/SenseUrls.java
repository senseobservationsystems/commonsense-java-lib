...
public class SenseUrls {
	...
	public static final String DELETE_SENSOR = BASE + "sensors/<id>" + FORMAT;
	public static final String DEV_DELETE_SENSOR = DEV_BASE + "sensors/<id>" + FORMAT;
	...
	public static final String CONNECTED_SENSORS = BASE + "sensors/<id>/sensors" + FORMAT + "?per_page=1000&details=full";
	public static final String DEV_CONNECTED_SENSORS = DEV_BASE + "sensors/<id>/sensors" + FORMAT + "?per_page=1000&details=full";

	public static final String MANUAL_LEARN = BASE + "sensors/%1/services/%2/manualLearn" + FORMAT;
	public static final String DEV_MANUAL_LEARN = DEV_BASE + "sensors/%1/services/%2/manualLearn" + FORMAT;

	public static final String REG = BASE + "users" + FORMAT;
	public static final String DEV_REG = DEV_BASE + "users" + FORMAT;

	public static final String GROUPS = BASE + "groups" + FORMAT;
